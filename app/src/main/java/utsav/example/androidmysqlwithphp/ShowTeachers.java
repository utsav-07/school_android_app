...
public class    ShowTeachers extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    RecyclerView recyclerView;
    MyTeachersAdapter myAdapter;
    List<ModelImage_Teachers> imageList;
    ModelImage_Teachers modelImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new MyTeachersAdapter(this,imageList);
    ...
    public void fetchImages(){
       ...
       // StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.0.102/publicschoolproject/admin/teacher_details.php",
                StringRequest request = new StringRequest(Request.Method.POST, "https://schlprj.000webhostapp.com/admin/teacher_details.php",
                        ...
                        try {
                            ...
                            if(succes.equals("1")){
                                ...
                                for(int i=0;i<jsonArray.length();i++){
                                    ...
                                    String username = object.getString("tname");
                                    String email = object.getString("tdescription");

                                    String imageurl = object.getString("avatar");

                                    /*  String url = "http://192.168.0.102/phpScripts/Images/"+imageurl; */
                                    //String url = "http://192.168.0.102/publicschoolproject/admin/"+imageurl;
                                    String url = "https://schlprj.000webhostapp.com/admin/"+imageurl;

                                    modelImage = new ModelImage_Teachers(username,email,url);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ShowTeachers.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });

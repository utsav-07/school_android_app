...
public class Take_student_attendance extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private static String webview_url   = Constants.URL_TAKE_STUDENT_ATTENDANCE;    // web address or local file location you want to open in webview
    ...
    private static final String TAG = admin_panel.class.getSimpleName();
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                ...
                if(file_permission() && Build.VERSION.SDK_INT >= 21) {
                    ...
                    if (includePhoto) {
                        ...
                        if (takePictureIntent.resolveActivity(Take_student_attendance.this.getPackageManager()) != null) {
                            File photoFile = null;
                            try {
                    ...
                    if (includeVideo) {
                        ...
                        if (takeVideoIntent.resolveActivity(Take_student_attendance.this.getPackageManager()) != null) {
                            File videoFile = null;
                            try {
    ...
    public boolean file_permission(){
        if(Build.VERSION.SDK_INT >=23 && (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
            ActivityCompat.requestPermissions(Take_student_attendance.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, 1);
            return false;
        }else{
            return true;
        }

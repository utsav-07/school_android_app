...
public class admin_panel extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private static String webview_url   = Constants.URL_ADMIN_SECTION;    // web address or local file location you want to open in webview
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                ...
                if(file_permission() && Build.VERSION.SDK_INT >= 21) {
                    ...
                    if (includePhoto) {
                        ...
                        if (takePictureIntent.resolveActivity(admin_panel.this.getPackageManager()) != null) {
                            File photoFile = null;
                            try {
                    ...
                    if (includeVideo) {
                        ...
                        if (takeVideoIntent.resolveActivity(admin_panel.this.getPackageManager()) != null) {
                            File videoFile = null;
                            try {
    ...
    public boolean file_permission(){
        if(Build.VERSION.SDK_INT >=23 && (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
            ActivityCompat.requestPermissions(admin_panel.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, 1);
            return false;
        }else{
            return true;
        }
